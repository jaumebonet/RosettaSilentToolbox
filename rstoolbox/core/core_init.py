...
try:
    ...
    # This avoids recalling this every time, as register_option will raise an error when trying to re-register.
    # Basically, this is the equivalent to Cpp's #IFDEF
    pass
